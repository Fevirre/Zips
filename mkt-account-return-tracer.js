📦
132765 /account-return/mkt-account-return-tracer.js
✄
...
function installIl2CppHooks() {
  Il2Cpp.perform(() => {
    const classPattern = /(account|nintendo|oauth|auth|login|link|deeplink|webview|reboot)/i;
    const methodPattern = /(account|nintendo|oauth|auth|login|link|callback|complete|result|resume|intent|token|reboot)/i;
